...
A console-based **Library Management System** is built  with **Core Java, JDBC, and MySQL**. Demonstrates clean OOPs design with a layered architecture (Model → DAO → Service → UI).
